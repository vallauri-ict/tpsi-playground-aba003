...
$(document).ready(function () {
  ...
  _lstModelli.on("change", function () {
    ...
    modelloSelecionado=_lstModelli.val(); //salvo l id del modello selezionato
  ...
  function dettagliClick() {
    ...
    let url=URL+"/modelli/"+modelloSelecionado;
        let request =inviaRichiesta("get",url);
        request.fail(errore);
    request.done(function name(modello) {
