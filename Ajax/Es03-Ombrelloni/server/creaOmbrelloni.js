...
$(document).ready(function () {
  ...
  for (let i = 1; i <= 666; i++) {
    ...
    for (let j = 1; j <= 107; j++) ombrellone.stato.push(0);
    ombrelloni.push(ombrellone);
  }

  let json = { utenti: utenti, ombrelloni: ombrelloni };
  json = JSON.stringify(json, null, 3); //il primo qullo che voglio serializzare  null, 3 crea una formattazione di 3 caratteri
